...
define('myapp/routes/posts', ['exports'], function (exports) {
  ...
  exports.default = Ember.Route.extend({
    model: function model() {
      var store = this.store;
      return Ember.RSVP.hash({
        content: this.get('store').findAll('post'),
...
define("myapp/templates/posts", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "UHoL2BfR", "block": "{\"symbols\":[],\"statements\":[[4,\"blog-posts\",null,[[\"posts\",\"page\",\"perPage\",\"query\",\"createAction\"],[[19,0,[\"model\"]],[19,0,[\"page\"]],[19,0,[\"perPage\"]],[19,0,[\"query\"]],\"createPost\"]],{\"statements\":[[1,[18,\"outlet\"],false]],\"parameters\":[]},null],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "myapp/templates/posts.hbs" } });
});
