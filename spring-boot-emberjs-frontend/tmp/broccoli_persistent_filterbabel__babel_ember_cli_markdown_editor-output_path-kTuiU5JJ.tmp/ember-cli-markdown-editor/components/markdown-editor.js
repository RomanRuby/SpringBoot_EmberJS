define('ember-cli-markdown-editor/components/markdown-editor', ['exports', 'ember-cli-markdown-editor/templates/components/markdown-editor'], function (exports, _markdownEditor) {
  'use strict';
  ...
  exports.default = Ember.Component.extend({
    layout: _markdownEditor.default,
     ...
     */
    handleTextareaBlur: function handleTextareaBlur() {
      var that = this,
    ...
    actions: {
       ...
       */
      applyStyle: function applyStyle(regex) {
        var requireSelection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        var promptText = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
        var tooltip = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
        var enter = arguments[4];
      ...
      setValue: function setValue(regex, enter) {
        var that = this,
       ...
       */
      addUndoStep: function addUndoStep(value) {
        var that = this,
